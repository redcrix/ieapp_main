(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/cdk/scrolling'), require('@angular/cdk/layout'), require('@angular/cdk/bidi'), require('@angular/cdk/platform'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-scrollbar', ['exports', '@angular/core', '@angular/common', '@angular/cdk/scrolling', '@angular/cdk/layout', '@angular/cdk/bidi', '@angular/cdk/platform', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global['ngx-scrollbar'] = {}, global.ng.core, global.ng.common, global.ng.cdk.scrolling, global.ng.cdk.layout, global.ng.cdk.bidi, global.ng.cdk.platform, global.rxjs, global.rxjs.operators));
}(this, function (exports, core, common, scrolling, layout, bidi, platform, rxjs, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgScrollbarView = /** @class */ (function () {
        ...
        NgScrollbarView.ctorParameters = function () { return [
            { type: scrolling.CdkVirtualScrollViewport, decorators: [{ type: core.Optional }] },
            { type: SmoothScroll, decorators: [{ type: core.Optional }] }
        ]; };
    ...
    var NgScrollbar = /** @class */ (function () {
            ...
            function () {
                if (!_this.disabled) {
                    if (_this.disableOnBreakpoints) {
                        ...
                        _this._breakpointObserver.observe(_this.disableOnBreakpoints).pipe(operators.tap((/**
                         * @param {?} result
                         * @return {?}
                         */
                        function (result) { return result.matches ? _this.disable() : _this.enable(); })), operators.takeUntil(_this._unsubscribe$)).subscribe();
                    }
                    else {
                        _this.enable();
                    }
                ...
                _this.updateObserver.pipe(operators.throttleTime(200), operators.tap((/**
                 * @return {?}
                 */
                function () { return _this._changeDetectorRef.markForCheck(); })), operators.takeUntil(_this._unsubscribe$)).subscribe();
                if (common.isPlatformBrowser(_this._platform)) {
                    // Update on window resize
                    rxjs.fromEvent(window, 'resize').pipe(operators.throttleTime(200), operators.tap((/**
                     * @return {?}
                     */
                    function () { return _this.update(); })), operators.takeUntil(_this._unsubscribe$)).subscribe();
                }
            }));
        };
        /**
        ...
        function () {
            ...
            if (this.view) {
                ...
                if (!this.customViewPort && this.autoUpdate && common.isPlatformBrowser(this._platform)) {
        ...
        NgScrollbar.propDecorators = {
            ...
            invertY: [{ type: core.Input }],
            invertX: [{ type: core.Input }],
            disableOnBreakpoints: [{ type: core.Input }],
            disabled: [{ type: core.Input, args: ['disabled',] }],
            verticalScrollbar: [{ type: core.ViewChild, args: ['y', { read: core.ElementRef },] }],
            horizontalScrollbar: [{ type: core.ViewChild, args: ['x', { read: core.ElementRef },] }],
            scrollViewport: [{ type: core.ViewChild, args: [scrolling.CdkScrollable,] }],
            viewSmoothScroll: [{ type: core.ViewChild, args: [SmoothScroll,] }],
            customViewPort: [{ type: core.ContentChild, args: [NgScrollbarView,] }]
        };
        return NgScrollbar;
    }());
    ...
    var NgScrollbarThumb = /** @class */ (function () {
        ...
        function () {
            ...
            if (common.isPlatformBrowser(this._platform)) {
                ...
                this._updateObserver$ = this._parent.updateObserver.pipe(operators.throttleTime(200), operators.tap((/**
                 * @return {?}
                 */
                function () { return _this.updateScrollbar(); })), 
                // Make sure scrollbar thumbnail position is correct after the new content is rendered
                operators.debounceTime(200), operators.tap((/**
                 * @return {?}
                 */
    ...
    var NgScrollbarY = /** @class */ (function (_super) {
        ...
        function () {
            ...
            /** @type {?} */
            var mouseMove$ = rxjs.fromEvent(this._document, 'mousemove');
            /** @type {?} */
            var mouseUp$ = rxjs.fromEvent(this._document, 'mouseup').pipe(operators.tap((/**
             * @return {?}
             */
            function () { return _this._document.onselectstart = null; })));
            return mouseDown$.pipe(operators.tap((/**
             * @return {?}
             */
            function () {
            ...
            })), operators.pluck('offsetY'), operators.mergeMap((/**
             * @param {?} mouseDownOffset
             * @return {?}
             */
            function (mouseDownOffset) { return mouseMove$.pipe(operators.takeUntil(mouseUp$), operators.pluck('clientY'), operators.tap((/**
        ...
        NgScrollbarY.ctorParameters = function () { return [
            ...
            { type: NgScrollbar, decorators: [{ type: core.Inject, args: [core.forwardRef((/**
                             * @return {?}
                             */
    ...
    var NgScrollbarX = /** @class */ (function (_super) {
        ...
        function () {
            ...
            })), operators.pluck('offsetX'), operators.mergeMap((/**
             * @param {?} mouseDownOffset
             * @return {?}
             */
            function (mouseDownOffset) { return mouseMove$.pipe(operators.takeUntil(mouseUp$), operators.pluck('clientX'), operators.tap((/**
             * @param {?} mouseMoveClient
             * @return {?}
             */
            function (mouseMoveClient) {
    ...
    exports.smoothScroll = smoothScroll;
    exports.ɵa = NgScrollbarView;
    exports.ɵb = NgScrollbarY;
    exports.ɵc = NgScrollbarThumb;
    exports.ɵd = NgScrollbarX;
